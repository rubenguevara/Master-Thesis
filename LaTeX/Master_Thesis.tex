...
\title{Model independent search for Dark Matter using Machine Learning
    ...
    In dilepton and Missing Transverse Energy final states with the ATLAS detector at the LHC 
}
...
\begin{figure}[!ht]
    ...
    \end{subfigure}
    \caption{$\Delta\Phi(l_c,E_T^{miss})$, $\Delta\Phi(l_l,E_T^{miss})$, $\Delta\Phi(l_1,l_2)$ and $m_{jj}$ distribution in control region.}
\end{figure}
\begin{figure}[!ht]
    \centering
    \begin{subfigure}[b]{0.49\textwidth}
    ...
    \end{subfigure}
    \caption{Leptons $p_T, \phi$ and $\eta$ distribution in control region.}
\end{figure}
\begin{figure}[!ht]
    \centering
    \begin{subfigure}[b]{0.49\textwidth}
    ...
    \end{subfigure}
    \caption{Leading jets $p_T, \phi$ and $\eta$ distribution in control region.}
\end{figure}
\begin{figure}[!ht]
    \centering
    \begin{subfigure}[b]{0.49\textwidth}
    ...
    \end{subfigure}
    \caption{$p_T^3, \phi^3$ and $\eta^3$ of jet, dilepton pair $E_T$, $H_T$ and $m_T$ distribution in control region.}
\end{figure}
\begin{figure}[!ht]
    \centering
    \begin{subfigure}[b]{0.49\textwidth}
    ...
    \end{subfigure}
    \caption{Number of b- and light jets and $E_T^{miss}/H_T$ distribution in control region.}
\end{figure}
