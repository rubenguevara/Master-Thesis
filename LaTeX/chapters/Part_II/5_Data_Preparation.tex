...
For the EFT model.
\subsection{SUSY}
The parameters that will be changed in this thesis are the masses of the slepton $m_{\tilde{\ell}}$ and the neutralino $m_{\tilde{\chi}_1^0}$. The masses used in this thesis are shown below
\subsection{2HDM + a}
For this model there are three important parameters, the mass of the new Higgs, which we will call $m_H$\footnote{Not to be confused with the SM Higgs mass, which we will not use in this thesis!}. The mass of the pseudoscalar $a$, $m_a$ and ratio between the vacuum expectation values of the Higgs doublet, $\tan\beta$. The values used for this thesis can be sen below.
