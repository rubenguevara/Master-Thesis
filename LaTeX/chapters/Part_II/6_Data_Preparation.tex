...
or $W\rightarrow l\nu_l$. The main production mechanism for these processes can be seen in Figure \ref{fig:Diboson_BKG}. From these diagrams we have that $WW\rightarrow ll+\nu\nu$, $WZ\rightarrow l\nu+ll$\footnote{Where one lepton is not reconstructed} and $ZZ\rightarrow ll+\nu\nu$, 
