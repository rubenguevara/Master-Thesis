...
\clearpage
\section{NN algorithm}\label{alg:nn}
\begin{lstlisting}[language=Python, caption={Neural network definition using TensorFlow}, captionpos=t]
...
\clearpage
\section{BDT algorithm}\label{alg:xgb}
\begin{lstlisting}[language=Python, caption={Boosted Decision Tree definition using XGBoost}, captionpos=t]
