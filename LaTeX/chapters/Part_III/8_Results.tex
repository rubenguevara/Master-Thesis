...
\chapter{Comparison to cut and count (Draft)}\label{chap:Results}
...
\begin{table}[!h]
    ...
    \label{tab:cuts}
\end{table}
\\ Since the cross-section to find Dark Matter is minuscule we have to use the low-statistics expected significance formula to find the closest to correct significance. The formula is
