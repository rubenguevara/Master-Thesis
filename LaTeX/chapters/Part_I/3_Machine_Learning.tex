...
The main approach of this thesis will be to use Machine Learning (ML) as its popular rise has proven to be effective at binary classification tasks \cite{DNN, DeepLearing} in High Energy Particle Physics. 
...
\subsection{Activation functions\todo{move this to chapter 3.3?}}\label{sec:act}
...
\subsection{Cost functions\todo{move this to chapter 3.3?}}
