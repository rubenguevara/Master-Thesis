...
and their variances. ADAM also uses momentum to accelerate the convergence of the optimization algorithm. However as we will be looking at extreme datasets in this thesis, we will use SGD rather than ADAM to reduce the risk to get stuck in a local minima of 
the loss phasespace, and since SGD is a more robust and conservative optimizer.
