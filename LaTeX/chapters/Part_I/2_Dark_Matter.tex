...
\section{Summary}
To summarize the models we will be studying in thesis. We have three models that stem from a $U(1)'$ extension of the SM, this $U(1)'$ extension contains a new vector boson $Z'$ which
