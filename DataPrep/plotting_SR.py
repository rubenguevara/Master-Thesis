...
Types = ["Drell Yan", 'Single Top', "Diboson", "W", "TTbar", "DH HDS m_{Z'} 130", "LV HDS m_{Z'} 130", "EFT HDS m_{Z'} 130"]
...
for vari in variables:
    ...
    for bkg in Backgrounds:
        for mc in mc_year:
            if bkg == "DH HDS m_{Z'} 130" or bkg == "LV HDS m_{Z'} 130" or bkg == "EFT HDS m_{Z'} 130":
    ...
    Plot_Maker(stack[vari], legend, isjet[vari], met_region[vari], hist[vari], data_hist[vari], save_dir, [stackDH[vari], stackLV[vari], stackEFT[vari]])
    # break