...
model_dir = 'Models/NN/DSID/WEIGHTED/TEST_METRIC/'
...
def NN_model(inputsize, n_layers, n_neuron, eta, lamda):
    ...
    model.compile(loss=tf.losses.BinaryCrossentropy(),
                optimizer=adam,
                weighted_metrics = [exp_sigificance])
                # metrics = [exp_sigificance(wgt = train_wgt), tf.keras.metrics.BinaryAccuracy(), tf.keras.metrics.AUC()])
    return model
...
for file in dsid_test:
    ...
    plot_dir = '../Plots/NeuralNetwork/DSID/'+part+'/TEST_METRIC/'
