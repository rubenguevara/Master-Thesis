...
sig_file = save_dir+'/DM_Models/DM_Zp_eft.h5'
...
plot_dir = '../../Plots/XGBoost/EFT_'+met_reg+'_MET/GRIDSEARCH/'
...
np_dir = '../Data/EFT_'+met_reg+'_MET/xgb_n_est_1e2-1e6/'
...
model.save_model(model_dir+'best_EFT_'+met_reg+'_MET.txt')